...
const int32_t N_TESTIMAGES = 3697;
...
bool eval(string result_sha,Mail* mail){
  ...
  string gt_dir         = "/u/xiaozhi/projects/3dboxproposals/code/frcn/data/kitti/object/training/label_2";
//  string result_dir     = "results/" + result_sha;
  ...
  // get image names
  string image_set_file = "/u/xiaozhi/projects/3dboxproposals/code/frcn/data/kitti/object/ImageSets/val.txt";
  FILE *fp = fopen(image_set_file.c_str(),"r");
  if (!fp) {
    return false;
  }
